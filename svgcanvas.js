...
var svgWhiteList = {
	"circle": ["class", "cx", "cy", "fill", "fill-opacity", "fill-rule", "id", "opacity", "r", "requiredFeatures", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "systemLanguage", "transform"],
	"defs": [],
	"desc": [],
	"ellipse": ["class", "cx", "cy", "fill", "fill-opacity", "fill-rule", "id", "opacity", "requiredFeatures", "rx", "ry", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "systemLanguage", "transform"],
	"g": ["class", "id", "display", "fill", "fill-opacity", "fill-rule", "opacity", "requiredFeatures", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "systemLanguage", "transform"],
	"image": ["class", "height", "id", "opacity", "requiredFeatures", "systemLanguage", "transform", "width", "x", "xlink:href", "xlink:title", "y"],
	"line": ["class", "fill", "fill-opacity", "fill-rule", "id", "opacity", "requiredFeatures", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "systemLanguage", "transform", "x1", "x2", "y1", "y2"],
	"linearGradient": ["id", "gradientTransform", "gradientUnits", "requiredFeatures", "spreadMethod", "systemLanguage", "x1", "x2", "y1", "y2"],
	"path": ["class", "d", "fill", "fill-opacity", "fill-rule", "id", "opacity", "requiredFeatures", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "systemLanguage", "transform"],
	"polygon": ["class", "id", "fill", "fill-opacity", "fill-rule", "id", "opacity", "points", "requiredFeatures", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "systemLanguage", "transform"],
	"polyline": ["class", "id", "fill", "fill-opacity", "fill-rule", "opacity", "points", "requiredFeatures", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "systemLanguage", "transform"],
...
// private members
	...
	// This array holds the uris for stamp images (wise4)
	// It is instantiated from accompanying json file when svgCanvas object is created
	var images = [];
...
// private functions
	...
	var removeUnusedGrads = function() {
		...
		$.each.each(all_els, function(i, el) {
...
// 	}
				...
				case "image":
					...
					var newImage = addSvgElementFromJson({
						...
						"attr": {
							"x": x,
							"y": y,
							// don't reset height and width (wise4)
							//"width": 0,
							//"height": 0,
							"id": getNextId(),
							"opacity": cur_shape.opacity / 2,
					...
					// set image uri to current stamp uri (wise4)
	        		newImage.setAttributeNS(xlinkns, "href", currStamp.uri);
	...
	//				canvas.addToSelection(getIntersectionList());
				...
				case "rect":
					// fall through
					// do not fall through to image case (wise4)
...
// 							element.y1.baseVal.value != element.y2.baseVal.value);
				...
				case "rect":
					...
					break;
				case "image":
					// when adding an image (stamp), assign dimensions and coordinates without dragging (on mouse click) (wise4)
...
// public functions
	...
	// Function: setStampImages (wise4)
	// This function sets the current uris for the stamp images.
	//
	// Parameters:
	// stamps - The array of image uris.
	this.setStampImages = function(stamps) {
		images = stamps;
	}
	
	// Function: setStamp (wise4)
	// This function sets the current uris for the stamp images.
	//
	// Parameters:
	// index - The selected image uri
